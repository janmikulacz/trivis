...
def main(args):
    ...
    args_gen_common = f'{args_gen_common} --mwt-iter-limit 10000'
    args_gen_common = f'{args_gen_common} --mwt-time-limit 360'
    for map_name, map_scale in maps:
        ...
        for simple_poly_max_size in simple_poly_max_sizes:
            ...
            if simple_poly_max_size <= 0:
                ...
                args_gen_max_size = f'{args_gen_max_size} --out-dir {args.output_dir}/mwt-dp-polysize-{simple_poly_max_size}'
                args_gen_queue.append(args_gen_max_size)
